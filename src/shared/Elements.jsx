  ...
  return (
    <div className="toolbar-links d-flex justify-content-center align-items-center">
      <div>
        <Link
          to={link}
          className="qodef-wishlist-widget-link"
          title="View Wishlist"
        >
          <div className="d-flex">
            <div>
              <span className="tl-icon-count-holder">
                ...
                {count === 0 || !count || (
                  <span className="tl-count" style={{ zoom: 1 }}>
                    {count}
                  </span>
                )}
              </span>
...
function Button({ handleOnClick, label, classes, disable }) {
  return (
    <div className="py-1 input-text-content w-auto">
      <button
        type="submit"
        className={`w-100 px-3 py-3 ${classes}`}
...
export { Button, GoogleBtn, ProgressBar, ToolBarTDP, Price, ItemFotter };
