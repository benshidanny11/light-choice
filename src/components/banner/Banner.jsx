...
import slideStatic from '../../assets/images/slider2.jpg';
...
function Banner({ slides }) {
  ...
  const hTips = [{h_image:slideSmall1},{h_image:slideSmall2}, {h_image:slideSmall3}]
  return (
    <section
      className="elementor-section elementor-top-section elementor-element elementor-element-9262bb8 elementor-section-full_width qodef-elementor-content-grid elementor-section-height-default elementor-section-height-default padding-10"
      data-id="9262bb8"
    ...
    >
      <div className="elementor-container elementor-column-gap-default">
        <div className="elementor-row">
          <div
            className="elementor-column elementor-col-70 elementor-top-column elementor-element elementor-element-08907b6"
            data-id="08907b6"
          ...
          <div
            className="elementor-column elementor-col-30 elementor-top-column elementor-element elementor-element-632ec9f"
            data-id="632ec9f"
            data-element_type="column"
          >
            <div className="elementor-column-wrap elementor-element-populated">
